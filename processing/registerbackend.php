...
if(isset($_POST['submit'])){
    ...
    while($row = mysqli_fetch_assoc($result)){
        array_push($existing_emails, $row['paul_usersemail']);
    }
...
if(count($error_messages) > 0){
    ...
    $sql = "INSERT INTO users (paul_usersname, paul_usersemail, paul_userspassword, paul_usersverified) VALUES ('$name', '$email', '$hashed_password', 0)";
