...
<body>
    ...
    if (isset($_SESSION['logged_in'])) {
        ...
        <tr>
            ...
            echo "<form action=\"editbookingsbackend.php\" method=\"POST\">";
            ...
            if (isset($_SESSION['usereditbookings_errors'])) {
                foreach ($_SESSION['usereditbookings_errors'] as $error) {
                    echo "<br>" . $error . "</br>";
                }
            } else if (empty($_SESSION['usereditbookings_errors'])) {
                echo "";
            }
            ...
            # though it would make sense for admin to be able to edit individual bookings too.
    ...
    <a href="viewbookings.php">Back</a>
